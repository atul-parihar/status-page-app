...
export const fetchServicesWithoutAuth = async () => {
  try {
    const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/services/public`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
...
export const fetchIncidentsWithoutAuth = async () => {
  try {
    const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/incidents/public`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      },
